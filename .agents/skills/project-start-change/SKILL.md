...
Follow this project's fixed worktree convention (do not use `EnterWorktree` - it creates
worktrees under `.Codex/worktrees/`, which conflicts with the path used here):
